...
with open('agents_all.csv', 'a',encoding='utf-8') as output_all:
            writer = csv.DictWriter(output_all, fieldnames=["paroles"])
            writer.writeheader()
...
if __name__=='__main__':
    ...
    #     wf.write(audio_folder_p+'/agent.wav',sr,voice_samples)
        ...
        try:
            with open(csv_folder_p+'/agent.csv', 'w',encoding='utf-8') as output:
                writer = csv.DictWriter(output, fieldnames=["paroles"])
                writer.writeheader()
                parole = get_text_from_voice(audio_folder_p+'/agent.wav')
        ...
        # with open(csv_folder_p+'/agent.csv', 'w',encoding='utf-8') as output2:
        #     writer = csv.DictWriter(output, fieldnames=["paroles"])
        #     writer.writeheader()
        #     print(get_text_from_voice(model,audio_folder_p+'/agent.wav'), file=output2)
